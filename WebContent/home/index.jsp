...
<head>
	...
	<title>Home</title>
	<link rel="favicon" href="../resources/home/assets/images/favicon.png">
    ...
    <link rel='stylesheet' id='camera-css'  href='../resources/home/assets/css/camera.css' type='text/css' media='all'> 
...
<body>
		...
		<div class="container">
             <div class="heading-text">							
                    ...
                    <div class="camera_wrap camera_emboss pattern_1" id="camera_wrap_4">
                        <div data-thumb="../resources/home/assets/images/slides/thumbs/img1.jpg" data-src="../resources/home/assets/images/slides/img1.jpg">
                            <h2>We develop.</h2>
                        </div> 
                        <div data-thumb="../resources/home/assets/images/slides/thumbs/img2.jpg" data-src="../resources/home/assets/images/slides/img2.jpg">
                        </div>
                        <div data-thumb="../resources/home/assets/images/slides/thumbs/img3.jpg" data-src="../resources/home/assets/images/slides/img3.jpg">
                        </div> 
                    </div><!-- #camera_wrap_3 -->
                </div><!-- .fluid_container -->
		</div>
  ...
  <div class="container">
    <div class="row">
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img src="../resources/home/assets/images/1.png" alt="" />
							</div><!--icon box top -->
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img src="../resources/home/assets/images/2.png" alt="" />
							</div><!--icon box top -->
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img src="../resources/home/assets/images/3.png" alt="" />
							</div><!--icon box top -->
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img src="../resources/home/assets/images/4.png" alt="" />
							</div><!--icon box top -->
							<h4>Placements</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue
							eset nec lacus elit dor broma.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="newsBox">
                        <div class="thumbnail">
                            <figure><img src="../resources/home/assets/images/news2.jpg" alt=""></figure>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="newsBox">
                        <div class="thumbnail">
                            <figure><img src="../resources/home/assets/images/news3.jpg" alt=""></figure>
                            <div class="caption maxheight2">
                            <div class="box_inner">
                                        <div class="box">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="newsBox">
                        <div class="thumbnail">
                            <figure><img src="../resources/home/assets/images/news4.jpg" alt=""></figure>
                            <div class="caption maxheight2">
                           <div class="box_inner">
                                        <div class="box">
  ...
  <div class="footerbottom">
	...
	<script type='text/javascript' src='../resources/home/assets/js/jquery.min.js'></script>
    <script type='text/javascript' src='../resources/home/assets/js/fancybox/jquery.fancybox.pack.js'></script>
    
    <script type='text/javascript' src='../resources/home/assets/js/jquery.mobile.customized.min.js'></script>
    <script type='text/javascript' src='../resources/home/assets/js/jquery.easing.1.3.js'></script> 
    <script type='text/javascript' src='../resources/home/assets/js/camera.min.js'></script> 
